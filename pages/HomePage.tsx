...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative p-[14px] ml-0 rounded-none max-w-[100vw] h-[95vh] min-h-[650px] flex flex-col">
         {/* Bento Box Container */}
         <div className="relative w-full h-full rounded-[2.5rem] md:rounded-[3rem] overflow-hidden flex flex-col justify-center items-center shadow-2xl">
           ...
           <div className="relative z-10 w-[958px] h-full grid grid-rows-[61.8fr_38.2fr]">
             {/* 61.8% Superior - Espacio libre para la fotografía (Proporción Áurea) */}
             <div className="w-full h-full pointer-events-none"></div>
             
             {/* 38.2% Inferior - Contenido y Buscador */}
             <div className="w-full h-full flex flex-col justify-end px-6 md:px-12 lg:px-20 pb-10 md:pb-16">
               <div className="max-w-4xl animate-fadeIn">
                 <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white mb-4 leading-tight tracking-tight-heading drop-shadow-2xl text-center">
                   Encuentra tu espacio <br/> <span className="italic font-light text-white/90">extraordinario.</span>
                 </h1>
                 <p className="text-white/90 text-base md:text-lg font-light mb-[32px] ml-[124px] drop-shadow-md max-w-xl text-center">
      ...
      <section className="py-24 max-w-[100vw] overflow-hidden">
      ...
      <section className="bg-white py-24 max-w-[100vw] overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-end mb-12">
           <div>
        ...
        {DEVELOPMENTS.map((dev, index) => (
          ...
          >
            ...
            <div className="relative h-full flex flex-col justify-center items-center text-center px-6 max-w-6xl mx-auto pt-20">
               ...
               <h2 className={`font-serif text-[81px] mb-6 text-white tracking-tight-heading leading-none transition-all duration-1000 delay-500 transform ${index === currentDevIndex ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                  {dev.name}
               </h2>
               
               <p className={`font-serif italic text-2xl md:text-3xl text-accent mb-10 max-w-3xl transition-all duration-1000 delay-700 transform ${index === currentDevIndex ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                  {dev.tagline}
               </p>
      ...
      <section className="py-24 bg-[#0B1120] relative max-w-[100vw] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 flex justify-between items-end mb-12">
          <div>
